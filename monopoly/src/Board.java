...
public class Board extends JFrame{
	...
	int cnt,stateP1,stateP2,hotelP1,hotelP2;
	Board(){
	...
	void result() {
		int scoreP1=Integer.parseInt(lblAmountPlayer1.getText());
		int scoreP2=Integer.parseInt(lblAmountPlayer2.getText());
		scoreP1+=stateP1+hotelP1;
		scoreP2+=stateP2+hotelP2;
		if(scoreP1>scoreP2) 
			JOptionPane.showMessageDialog(this, "Player 1 won by Rs."+(scoreP1-scoreP2));
		else if(scoreP2>scoreP1) 
			JOptionPane.showMessageDialog(this, "Player 2 won by Rs."+(scoreP2-scoreP1));
		else
